module AniGFAna__flowAna
   use AniGFAna__types, only: WP, raggedIntArr
...
contains
   ...
   subroutine w0Calcs(flowTime, JE4i, JEij, xiNumList, nEval, targws, xEval, &
                      wijSplineEval, w4iSplineEval, flowTimeForW0, w0ij, w04i)
